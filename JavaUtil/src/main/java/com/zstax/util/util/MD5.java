 ...
 */
public class MD5 {
	private static Logger logger = Logger.getLogger(com.my.util.md5.MD5.class);
	/**
	 * 對字符串進行MD5加密
	 * @author tianwl
	 * @param s
	...
	public final static String getStringMD5(String s) {
		...
		return com.my.util.md5.MD5.getByteArrayMD5(strTemp);
	}
	/**
	 * 對byte数组進行MD5加密
	 * @author tianwl
	...
	public static String getPictureMD5(String pic,String url){
		...
		sb.append(url);
		md5 = com.my.util.md5.MD5.getStringMD5(new String(sb));
		return md5;
	}
	...
	public static void main(String[] args) {
		System.out.println(com.my.util.md5.MD5.getStringMD5("aaaaaaaaaaaaaaaaaaa"));
		byte[] source = "aaaaaaaaaaaaaaaaaaa".getBytes();
		System.out.println(com.my.util.md5.MD5.getByteArrayMD5(source));
		logger.info(com.my.util.md5.MD5.getPictureMD5("asdfasdfadf", "www.163.com"));
	}
}
