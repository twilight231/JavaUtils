package com.my.util.md5;

// Md5_2.java
// $Id: Md5_2.java,v 1.4 1999/12/06 13:13:58 ylafon Exp $
...
public class Md5_2 {
    ...
    public Md5_2(String input, String enc) {
         byte bytes [] = null;
        try {
