package com.my.util.upload;

import com.my.util.file.FileFiend;
...
//                        String ext = "."+FileFiend.getTypePart(name);
                        try {
                            //保存上传的文件到指定的目录
                            ...
                            else
                            {
                                ...
                                if (isSmallPic)
                                {
                                    uploadfilename = dstPath +"/"+ newFileName+"_"+picSeqNo+"_small";
                                }
                                else
                                {
                                    uploadfilename = dstPath +"/"+ newFileName+"_"+picSeqNo;
                                }
                                //生成所有未生成的目录
