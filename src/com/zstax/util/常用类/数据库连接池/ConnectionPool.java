...
public class ConnectionPool {
	 ...
	 * @param jdbcDriver String JDBC �����മ

	 * @param dbUrl String ���ݿ� URL

	 * @param dbUsername String �������ݿ��û���

	 * @param dbPassword String �������ݿ��û�������
